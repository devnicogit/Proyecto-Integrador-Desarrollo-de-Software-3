...
La muestra estuvo conformada por **n = 150 registros operativos** en el pre-test (02/03/2026 – 18/04/2026, 43 días hábiles) — datos reales extraídos del registro manual de guías GR-1001 a GR-1150 — y **n = 150 registros operativos** en el post-test (20/04/2026 – 31/05/2026, 42 días hábiles), seleccionados mediante muestreo aleatorio simple sobre el total de servicios ejecutados a través del sistema EcoRoute en el periodo, totalizando 300 servicios documentados. La unidad de análisis para las pruebas inferenciales fue el **porcentaje diario** de cumplimiento de cada indicador, lo que produce 43 observaciones diarias en el pre-test y 42 observaciones en el post-test, emparejadas posicionalmente para el análisis t de Student.
